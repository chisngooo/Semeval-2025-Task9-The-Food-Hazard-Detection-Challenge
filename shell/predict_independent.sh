...
output_hazard_json_path="results/public/hazard/hazard_predictions_roberta-large-768.json"
output_product_json_path="results/public/product/product_predictions_roberta-large-768.json"
cd ..
